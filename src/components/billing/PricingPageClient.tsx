      ...
      <div className="card" style={{ overflowX: "auto" }}>
        <table className="w-full" style={{ borderCollapse: "collapse", minWidth: 900, fontSize: 13 }}>
          ...
          <tbody>
            ...
            <tr><td style={{ padding: "8px 12px", color: "var(--t2)" }}>Sub-áreas</td><td style={{ textAlign: "center" }}>Hasta 4</td><td style={{ textAlign: "center" }}>Hasta 4</td><td style={{ textAlign: "center" }}>Ilimitadas</td><td style={{ textAlign: "center" }}>Ilimitadas</td><td style={{ textAlign: "center" }}>Ilimitadas</td></tr>
            <tr><td style={{ padding: "8px 12px", color: "var(--t2)" }}>Orgs activas máx.</td><td style={{ textAlign: "center" }}>5</td><td style={{ textAlign: "center" }}>5</td><td style={{ textAlign: "center" }}>Ilimitadas</td><td style={{ textAlign: "center" }}>Ilimitadas</td><td style={{ textAlign: "center" }}>Ilimitadas</td></tr>
